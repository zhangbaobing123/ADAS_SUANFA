...
void LoadGT(vector<Ellipsed>& gt, const string& sGtFileName, bool bIsAngleInRadians)
{
...
// Should be checked
bool LoadTest(vector<Ellipsed>& ellipses, const string& sTestFileName, vector<double>& times, bool bIsAngleInRadians)
{
